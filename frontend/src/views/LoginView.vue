<template>
  <div class="auth-page">
    <div class="auth-card">
      ...
      <form @submit.prevent="handleLogin" class="auth-form" novalidate>
        <div class="input-group">
          ...
          <input v-model="form.email" type="email" placeholder="Email address" required class="auth-input" />
        </div>
        <div class="input-group">
          <span class="input-icon" aria-hidden="true">
          ...
          <input v-model="form.password" type="password" placeholder="Password" required class="auth-input" />
        </div>
    ...
    <div class="auth-card switch-card">
      <p>New to the forge? <router-link to="/register" class="link">Create an account</router-link></p>
    </div>
  </div>
</template>
