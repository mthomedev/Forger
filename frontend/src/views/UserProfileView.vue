        ...
        <div class="posts-grid-container">
          ...
          <div v-else class="posts-grid">
            <router-link
              ...
              class="grid-item"
            >
              <img v-if="post.image_url" :src="getImageUrl(post.image_url)" class="grid-image" loading="lazy" />
              <div v-else class="grid-placeholder" aria-hidden="true">
                <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor"><path d="M7 2v11h3v9l7-12h-4l4-8H7z" /></svg>
              </div>
